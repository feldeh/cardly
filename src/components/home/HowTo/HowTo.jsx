  ...
  return (
    <div className="mb-32">
      ...
      <div className="flex justify-center mt-[50px]">
        <div className=" bg-[#E8E8E7] relative max-smartphone:w-full smartphone:rounded-[55px] lg:pb-[130px]">
          <div className="mx-[50px] text-center text-[28px] leading-8 pt-10 pb-[150px] lg:mx-[200px] lg:text-[60px] lg:leading-[60px] lg:pt-16">
