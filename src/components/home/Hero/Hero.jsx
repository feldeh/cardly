...
const Hero = () => {
  return (
    <div className="smartphone:pt-[150px] lg:pt-[190px] xl:pt-[190px] mb-[65px] smartphone:pb-[5px] sm:pb-[70px] md:pb-[1px] lg:pb-[115px] largeScreen:pb-[250px] xl:pb-[350px] bg-black text-white w-full">
